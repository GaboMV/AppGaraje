...
import '../../features/booking/screens/payment_upload_screen.dart';
...
class AppRoutes {
  ...
  static const verifyEmail = '/verify-email/:email';
  ...
  static const String paymentUpload = '/payment-upload/:reservaId';
  static const String myGarages = '/my-garages';
...
final appRouterProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        path: AppRoutes.walletDashboard,
        builder: (ctx, state) => const WalletDashboardScreen(),
      ),
      GoRoute(
        path: AppRoutes.paymentUpload,
        builder: (ctx, state) {
          final reservaId = state.pathParameters['reservaId']!;
          return PaymentUploadScreen(reservaId: reservaId);
        },
      ),
      GoRoute(
        path: AppRoutes.myGarages,
        builder: (ctx, state) => const MyGaragesScreen(),
      ),
      GoRoute(
        path: AppRoutes.garageCreate,
        builder: (ctx, state) => const GarageCreateWizard(),
      ),
      GoRoute(
        path: AppRoutes.garageEdit,
        builder: (ctx, state) {
          final garage = state.extra as GarageModel;
          return GarageEditScreen(garage: garage);
        },
      ),
      GoRoute(
        path: AppRoutes.garageCalendar,
        builder: (ctx, state) {
          final garage = state.extra as GarageModel;
