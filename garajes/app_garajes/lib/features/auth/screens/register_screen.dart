  ...
  Future<void> _submit() async {
    ...
    try {
      await ref.read(authProvider.notifier).register(
            ...
            telefono: '+591${_phoneCtrl.text.trim()}',
            password: _passCtrl.text,
          );
      if (mounted) {
        context.go(AppRoutes.verifyEmail.replaceAll(':email', _emailCtrl.text.trim()));
      }
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        validator: (val) {
                          ...
                          if (clean.length != 8 || !RegExp(r'^[0-9]{8}$').hasMatch(clean)) {
