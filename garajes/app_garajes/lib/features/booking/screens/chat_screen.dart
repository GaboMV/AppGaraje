...
class ChatMessage {
  ...
  final DateTime time;
  final bool isSystem;
  /// R2 object key for an image attachment, null if the message is text-only.
...
class _ChatScreenState extends ConsumerState<ChatScreen> {
  ...
  void initState() {
    super.initState();
    debugPrint('[ChatScreen] Ciclo de vida initState invocado.');
    ...
    _messages.add(ChatMessage(
      content:
          'Tu comunicaciÃ³n es segura. Por favor mantÃ©n el respeto durante la negociaciÃ³n.',
      senderId: 'system',
      senderName: 'Sistema',
      time: DateTime.now(),
      isSystem: true,
      ...
      if (mounted) {
        setState(() {
          for (var m in list) {
            ...
            // Extract the R2 key from the first adjunto, if any
            final adjuntos = m['adjuntos'] as List?;
            final attachmentKey = adjuntos != null && adjuntos.isNotEmpty
                ? adjuntos.first['url']?.toString()
                : null;
  ...
  void _onReceiveMessage(dynamic data) {
    ...
    // Filtrar: Verificar si el mensaje pertenece a la reserva actual
    final incomingReservaId = data['id_reserva']?.toString();
    if (incomingReservaId != null && incomingReservaId != widget.reservationId) {
      debugPrint('[ChatScreen] Ignorando mensaje de otra reserva: $incomingReservaId');
      return;
    }
                  ...
                  child: Row(
                    children: [
                      ...
                      IconButton(
                        ...
                        onPressed: () {
                          debugPrint('[ChatScreen] Reintento manual de conexiÃ³n global...');
                          ...
                          children: [
                            Text('Reserva Confirmada',
                                style: TextStyle(
                                    ...
                                    fontWeight: FontWeight.w700,
                                    fontSize: 13)),
                            Text('El pago se realizÃ³ con Ã©xito',
                                style: TextStyle(
                                    color: AppTheme.textSecondary,
                                    fontSize: 11)),
                          ],
          ...
          ConstrainedBox(
            ...
            child: Column(
              ...
              children: [
                ...
                // â”€â”€ Image attachment â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
                ...
                // â”€â”€ Text bubble (hidden when content is empty) â”€â”€â”€â”€â”€â”€â”€â”€
      ...
      child: Column(
        ...
        children: [
          ...
          _PayOption(
            ...
            subtitle: 'Recomendado Â· InstantÃ¡neo',
