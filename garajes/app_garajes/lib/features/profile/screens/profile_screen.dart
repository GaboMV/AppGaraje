...
class ProfileScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    debugPrint('ProfileScreen - User ID: ${user?.id}');
    myGaragesState.whenOrNull(data: (list) {
      debugPrint('ProfileScreen - Garages found: ${list.length}');
      for (var g in list) {
        debugPrint('ProfileScreen - Garage ID: ${g.id}, Aprobado: ${g.estaAprobado}');
      }
    });
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  // Multi-pestaÃ±a: Mis Garajes / Quiero Alquilar
                     ...
                     myGaragesState.when(
                      data: (garages) {
                        ...
                        if (user?.isPropietario == true) {
                          ...
                          if (todosPendientes) {
                            return _ProfileOption(
                              ...
                              label: 'Solicitud en atenciÃ³n',
                              subtitle: 'Tu espacio estÃ¡ siendo validado',
                              onTap: () {
                                ScaffoldMessenger.of(context).showSnackBar(
                                  const SnackBar(content: Text('Tu solicitud estÃ¡ siendo atendida por un administrador.')),
                                );
                              },
                            );
                          } else {
                        ...
                        return _ProfileOption(
                          ...
                          subtitle: 'Publica tu primer garaje aquÃ­',
                          onTap: () {
